    ...
    <header className="fixed top-0 w-full bg-gray/90 bg-opacity-80 backdrop-blur-md z-50">
      <nav className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="hidden md:flex space-x-4">
          <button
            onClick={onSignup}
            className="px-4 py-2 rounded-lg bg-primary text-blue-300 transition-colors duration-200"
          >
            Sign Up
          </button>
          <button
            onClick={onLogin}
            className="px-4 py-2 rounded-lg border border-primary hover:bg-primary text-blue-300 transition-all duration-200"
          >
            Log In
          </button>
        </div>
